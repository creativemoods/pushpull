...
class PushPull {
	...
	*/
	public function boot() {
		...
		add_filter('pushpull_meta__generateblocks_reusable_blocks', array(&$gb, 'meta__generateblocks_reusable_blocks'), 10, 2);
		add_filter('pushpull_export', array(&$gb, 'export'), 10, 2);
	}
