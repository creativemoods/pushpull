...
final class WpmlTranslationManagementAdapter implements OverlayManagedContentAdapterInterface, ManagedSetDependencyAwareInterface, OverlayManagedSetInterface
{
    ...
    private function resolveWpmlTaxonomyTerm(string $taxonomy, int $elementId): ?WP_Term
    {
        ...
        // phpcs:disable WordPress.DB.DirectDatabaseQuery.DirectQuery,WordPress.DB.PreparedSQL.InterpolatedNotPrepared,PluginCheck.Security.DirectDB.UnescapedDBParameter -- Resolving WPML taxonomy translation rows must bypass WPML-filtered term APIs and read the raw core taxonomy rows directly.
        ...
        return $this->hydrateTerm($row, $taxonomy);
    }
